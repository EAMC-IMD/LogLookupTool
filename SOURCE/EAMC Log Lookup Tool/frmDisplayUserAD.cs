    ...
    public partial class frmDisplayUserAD : Form {
        ...
        private StringBuilder GetUserData() {
            DirectorySearcher search = new DirectorySearcher {
                SearchRoot = new DirectoryEntry("LDAP://OU=Users,OU=EAMC,OU=DoD,DC=med,DC=ds,DC=osd,DC=mil")
            };
        ...
        private StringBuilder GetComputerData() {
            DirectorySearcher search = new DirectorySearcher {
                SearchRoot = new DirectoryEntry("LDAP://OU=Workstations,OU=EAMC,OU=DoD,DC=med,DC=ds,DC=osd,DC=mil")
            };
